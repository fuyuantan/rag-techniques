This code aims to evaluate our RAG using metrics such as **hit rate, precision, recall, and golden answer keywords**. We define golden ground truth data (json) in `evaluate_retrieval.py`.
